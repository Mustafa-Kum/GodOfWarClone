...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FWaitSpawnEnemiesDelgate, const TArray<AWarriorEnemyCharacter*>&, SpawnedEnemies);
...
public:
	...
	FWaitSpawnEnemiesDelgate OnSpawnedFinished;

	UPROPERTY(BlueprintAssignable)
	FWaitSpawnEnemiesDelgate DidNotSpawn;
